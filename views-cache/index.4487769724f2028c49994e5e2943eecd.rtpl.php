<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="container col-md-4">
    ...
    <form action="/exibe" method="get">
        <div class="form-group">
            ...
            <input type="number" name="qtdDezenas" class="form-control" id="formGroupExampleInput" placeholder="Informe o número de dezenas">
        </div>
        <div class="form-group">
            <label for="formGroupExampleInput2">Número de jogos:</label>
            <input type="number" name="nJogos" class="form-control" id="formGroupExampleInput2" placeholder="Informe o número de jogos">
        </div>
